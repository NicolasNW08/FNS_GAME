...
from src.core.language.es_ES import LEVELS_FREE_DIFFICULTY_DIALOGUES
from src.core.language.es_ES import LEVELS_VERSUS_DIFFICULTY_DIALOGUES, VERSUS_DIALOGUES
