...
from src.core.module.levels_menu.validation import validation_versus
...
from src.core.module.levels_menu.dialogues_randoms import random_dialog_add_players, random_dialog_difficulty
